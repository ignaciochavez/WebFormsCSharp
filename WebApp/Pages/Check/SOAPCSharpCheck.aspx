<%@ Page Title="SOAPCSharpCheck" Language="C#" MasterPageFile="~/Pages/Shared/Template.Master" AutoEventWireup="true" CodeBehind="SOAPCSharpCheck.aspx.cs" Inherits="WebApp.Pages.Check.SOAPCSharpCheck" %>
        ...
        <div class="mt-3 pb-3 container" style="border: 3px solid rgba(50, 50, 50, 0.3); border-radius: 6px;">
            <div class="row">
                <div class="col-md-6 text-center my-auto mx-auto">
                    <h1 class="mt-3">SOAPCSharpCheck</h1>
                </div>
            </div>
